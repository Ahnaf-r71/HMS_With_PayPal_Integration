...
<?php
    ...
    define("HOTELIMAGE","http://localhost/luxInn/admin-panel/hotels-admins/hotel_images");
    define("ROOMIMAGE","http://localhost/luxInn/admin-panel/rooms-admins/room_images");
