    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(<?php echo HOTELIMAGE; ?>/<?php echo $hotel->image;?>);"></div>
					...
					<?php foreach($allRooms as $room): ?>
						<div class="col-lg-6">
							<div class="room-wrap d-md-flex">
								<a href="#" class="img" style="background-image: url(<?php echo ROOMIMAGE; ?>/<?php echo $room->image?>);"></a>
