	...
	if(isset($_GET['id'])){
		...
		if(isset($_POST['submit'])){
			...
			if(!isset($_SESSION['id'])){
				echo "<script>alert('You must be logged in to book a room');</script>";
				echo "<script>window.location.href='".APPURL."/auth/login.php'</script>"; // Redirect to login page
			}
...
<div class="hero-wrap js-fullheight" style="background-image: url('<?php echo ROOMIMAGE; ?>/<?php echo $singleRoom->image; ?>');" data-stellar-background-ratio="0.5">
